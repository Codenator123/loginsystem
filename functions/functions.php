...
function getMerkPro(){
 ...
 function getKlantOrder(){

 if(!isset($_GET['username'])){

 global $con;

 $get_klanto = "select * from verhuur where username='$username'";

 $run_klanto = mysqli_query($con, $get_klanto);

 while($row_klanto = mysqli_fetch_array($run_klanto)){

  $id = $row_klanto['id'];
  $username = $row_klanto['username'];
  $phone = $row_klanto['phone'];
  $date_pickup = $row_klanto['date_pickup'];
  $date_deliver = $row_klanto['date_deliver'];
  $date_pickup2 = $row_klanto['date_pickup2'];
  $date_deliver2 = $row_klanto['date_deliver2'];
  $date_pickup3 = $row_klanto['date_pickup3'];
  $date_deliver3 = $row_klanto['date_deliver3'];
  $pickup = $row_klanto['pickup'];
  $deliver = $row_klanto['deliver'];
